    ...
    <section id='pricing-plan'>
        <div className="container">
            <div className="pricing__top">
                ...
                <p>You must choose the appropriate price so that you can choose the appropriate trainer to start exercising with.<br/>
                   You must first determine the price and the trainer through the cards below in front of you.
                </p>
            </div>
