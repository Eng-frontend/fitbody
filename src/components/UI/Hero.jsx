    ...
    <div className="container">
        <div className="hero__wrapper">
            ...
            <div className="hero__content">
                <h2 className='section__title' data-aos='fade-up' data-aos-duration="1500">Exercise is the key to a 
                    <span className="highlights"> Healthy </span>
                Lifestyle</h2>
                <p data-aos='fade-up' data-aos-delay='100' data-aos-duration="1800">It is difficult to ignore the health benefits of regular exercise and physical activity. <br /> 
                
                which benefit everyone regardless of age, gender or physical ability.</p>
